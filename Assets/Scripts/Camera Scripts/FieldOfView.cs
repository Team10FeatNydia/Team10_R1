...
public class FieldOfView : MonoBehaviour 
{
	...
	void DrawFieldOfView ()
	{
		...
		for (int i = 0; i <= stepCount; i++) 
		{
			...
			if (i > 0) 
			{
				bool edgeDistanceThresholdExceeded = Mathf.Abs (oldViewCast.lengthOfRay - newViewCast.lengthOfRay) > edgeDistanceThreshold;
	...
	EdgeInfo FindEdge(ViewCastInfo minViewCast, ViewCastInfo maxViewCast)
	{
		...
		for (int i = 0; i < edgeResolveIteration; i++) 
		{
			...
			bool edgeDistanceThresholdExceeded = Mathf.Abs (minViewCast.lengthOfRay - newViewCast.lengthOfRay) > edgeDistanceThreshold;
	...
	public struct ViewCastInfo
	{
		...
		public ViewCastInfo (bool _hit, Vector3 _point, float _lengthOfRay, float _angle)
		{
			hit = _hit;
			point = _point;
